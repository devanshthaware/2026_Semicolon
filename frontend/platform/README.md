# TruthLayer - AI Verification Infrastructure Dashboard

A premium, production-ready SaaS dashboard for TruthLayer, an enterprise-grade AI output verification platform. Built with Next.js 16, TypeScript, Tailwind CSS, and shadcn/ui components.
