...
This provides a reproducible engineering proof for artifact loading, feature order, fusion inference, calibration metadata, and receipt generation. It does **not** validate TruthLayer’s research claims: synthetic data must never be used for production accuracy, AUROC, or coverage statements.

The executable notebook at `notebooks/truthlayer_synthetic_proof.ipynb` verifies the generated files, recomputes linear predictions, and demonstrates semantic-entropy calculations.
